...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec('python3 -m pip install nbconvert ipykernel');
    ...
    `;
            ...
            yield Promise.all(notebookFiles.map((notebookFile) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield exec.exec(`jupyter nbconvert --execute --no-input --to custom --template=${templatePath} --output "${parsedNotebookFile}" "${notebookFile}"`);
            }))).catch((error) => {
