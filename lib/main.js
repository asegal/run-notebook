...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec('python3 -m pip install nbconvert ipykernel papermill');
...
`;
                ...
                yield exec.exec(`jupyter nbconvert --execute --no-input --to html --output "${parsedNotebookFile}.html" "${notebookFile}"`);
            }))).catch((error) => {
